...
namespace snakeCFG {
	constexpr vec2 SNAKE_START_POSITION = vec2(3, 3);
	constexpr Directions SNAKE_START_DIRECTION = D_RIGHT;
	constexpr int MOVE_INTERVAL = 12;
	constexpr int MAX_APPLE_RETRIES = 128;
}
...
namespace RGB565 {
	...
	constexpr unsigned short GREY = 0x7BEF;
	constexpr unsigned short WHITE = 0xFFFF;
}
